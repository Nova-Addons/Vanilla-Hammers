...
import xyz.xenondevs.nova.material.NovaMaterialRegistry.item
...
object Items {
    ...
    val WOODEN_HAMMER = registerItem(VanillaHammers, "wooden_hammer", Tool, Hammer, Damageable, Enchantable, Fuel)
    ...
    val NETHERITE_HAMMER = registerItem(VanillaHammers, "netherite_hammer", Tool, Hammer, Damageable, Enchantable, FireResistant)
    ...
    val FIERY_HAMMER = registerItem(VanillaHammers, "fiery_hammer", Tool, Hammer, Damageable, Enchantable, FireResistant)
